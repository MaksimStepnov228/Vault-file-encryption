...
class VaultApp(tk.Tk):
    def __init__(self):
        ...
        for f in ["ico1.png", "ico2.png", "ico3.png", "ico4.png"]:
            img = Image.open(resource_path(f)).resize((22, 22), Image.LANCZOS)
            self.ico_imgs.append(ImageTk.PhotoImage(img))

        logo_raw = Image.open(resource_path("ico1.png")).resize((28, 28), Image.LANCZOS)
